...
export class TopupController {
  constructor(
    private readonly getTopupHistory: GetTopupHistoryDatatableUseCase,
  ...
  async getTopupHistoryDatatable(
    ...
    return this.getTopupHistory.execute(user.id, query);
  }
  ...
  createPayment(
    ...
    return this.processTopup.execute(
      user,
  ...
  confirmPayment(@Param('chargeId') chargeId: string) {
    return this.confirmTopup.execute(chargeId);
  }
}
