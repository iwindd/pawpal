...
interface EmployeeSuspensionHistoryDatatableProps {
  userId: string;
}

const EmployeeSuspensionHistoryDatatable = ({
  userId,
}: EmployeeSuspensionHistoryDatatableProps) => {
  ...
  const { data, isLoading } = useGetEmployeeSuspensionsQuery({
    id: userId,
    params: {
      page: datatable.page,
...
export default EmployeeSuspensionHistoryDatatable;
